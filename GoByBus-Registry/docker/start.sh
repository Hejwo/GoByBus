...
-Xms400m -Xmx400m -XX:MaxMetaspaceSize=100m \
-XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/tmp/goByBus-configServer/logs/ \
-XX:+PrintGCDateStamps -verbose:gc -XX:+PrintGCDetails -Xloggc:"/tmp/goByBus-registry/logs/goByBus-registry-gc-log.log" \
